        ...
        public void Load(List<System.Windows.Forms.PictureBox> boxList, int page) 
        {
            ...
            string[] textArray = text.Split('\n');
                ...
                for (int i = 72 * page; i < textArray.Length; i++) // ICI AJOUTER LES NOUVEAUX VAISSEAUX/BONUS
                {
                    ...
                    else if (textArray[i].Contains("BC"))
                        listImageToLoad.Add(global::LevelEditor.Properties.Resources.BC);
                    else if (textArray[i].Contains("support"))
                        listImageToLoad.Add(global::LevelEditor.Properties.Resources.support);
                    else if (textArray[i].Contains("targeter"))
                        listImageToLoad.Add(global::LevelEditor.Properties.Resources.targeter);
                    else if (textArray[i].Contains("zebra"))
                        listImageToLoad.Add(global::LevelEditor.Properties.Resources.Zebra);
                    else if (textArray[i].Contains("score"))
                        listImageToLoad.Add(global::LevelEditor.Properties.Resources.Score);
                    else if (textArray[i].Contains("energie"))
                        listImageToLoad.Add(global::LevelEditor.Properties.Resources.Energie);
                    else
