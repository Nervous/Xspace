...
namespace LevelEditor
{
    public partial class LevelEditor : Form
    {
        ...
        private void resetPictures(object sender, EventArgs e, int avoid)
        {
            ...
            if (avoid != 9)
                pictureBox73_Click(sender, e);

            if (avoid != 10)
                pictureBox83_Click(sender, e);

            if (avoid!= 11)
                pictureBox82_Click(sender,e);

            if (avoid != 12)
                pictureBox84_Click(sender, e);

            if (avoid != 13)
                pictureBox85_Click(sender, e);
        ...
        private void button2_Click(object sender, EventArgs e) // next
        {
            ...
            page++;
            Plot plot = new Plot(position, time, page, 0, selected+30, pictureBox8, global::LevelEditor.Properties.Resources.empty);
         ...
         private void button1_Click_1(object sender, EventArgs e) // back
        {
         ...
         {
             if ((selected != 9) && (!reset)) // Clic de base pour séléctionner le vaisseau
             {
                 saveimage = pictureBox73.Image;
                 resetPictures(sender, e, 9);
                 pictureBox73.Image = global::LevelEditor.Properties.Resources.supportbrillance;
                 selected = 9;
             }
             else if (!reset) // On retire le rectangle rouge quand le joueur reclique 
             {
                 pictureBox73.Image = global::LevelEditor.Properties.Resources.support;
                 selected = 0;
                 saveimage = global::LevelEditor.Properties.Resources.Sans_titre;
             }
             else if (selected ==9)
         ...
         {
             if ((selected != 8) && (!reset)) // Clic de base pour séléctionner le vaisseau
             {
                 saveimage = pictureBox6.Image;
                 resetPictures(sender, e, 8);
                 pictureBox6.Image = global::LevelEditor.Properties.Resources.BCbrillance;
                 selected = 8;
             }
             else if (!reset) // On retire le rectangle rouge quand le joueur reclique 
             {
                 pictureBox6.Image = global::LevelEditor.Properties.Resources.BC;
                 selected = 0;
                 saveimage = global::LevelEditor.Properties.Resources.Sans_titre;
             }
             else if (selected == 8)
         ...
         {
             if ((selected != 11) && (!reset)) // Clic de base pour séléctionner le vaisseau
             {
                 saveimage = pictureBox82.Image;
                 resetPictures(sender, e, 11);
                 pictureBox82.Image = global::LevelEditor.Properties.Resources.Zebrabrillance;
                 selected = 11;
             }
             else if (!reset) // On retire le rectangle rouge quand le joueur reclique 
             {
                 pictureBox82.Image = global::LevelEditor.Properties.Resources.Zebra;
                 selected = 0;
                 saveimage = global::LevelEditor.Properties.Resources.Sans_titre;
             }
             else if (selected == 11)
         ...
         {
             if ((selected != 10) && (!reset)) // Clic de base pour séléctionner le vaisseau
             {
                 saveimage = pictureBox83.Image;
                 resetPictures(sender, e, 10);
                 pictureBox83.Image = global::LevelEditor.Properties.Resources.targetterbrillance;
                 selected = 10;
             }
             else if (!reset) // On retire le rectangle rouge quand le joueur reclique 
             {
                 pictureBox83.Image = global::LevelEditor.Properties.Resources.targeter;
                 selected = 0;
                 saveimage = global::LevelEditor.Properties.Resources.Sans_titre;
             }
             else if (selected == 10)
         ...
         {
             if ((selected != 12) && (!reset))
             {
                 saveimage = pictureBox84.Image;
                 resetPictures(sender, e, 12);
                 pictureBox84.Image = global::LevelEditor.Properties.Resources.Energiebrillance;
                 selected = 12;
             }
             else if (!reset)
             {
                 pictureBox84.Image = global::LevelEditor.Properties.Resources.Energie;
                 selected = 0;
                 saveimage = global::LevelEditor.Properties.Resources.Sans_titre;
             }
             else if (selected == 12)
         ...
         {
             if ((selected != 13) && (!reset))
             {
                 saveimage = pictureBox85.Image;
                 resetPictures(sender, e, 13);
                 pictureBox85.Image = global::LevelEditor.Properties.Resources.Scorebrillance;
                 selected = 13;
             }
             else if (!reset)
             {
                 pictureBox85.Image = global::LevelEditor.Properties.Resources.Score;
                 selected = 0;
                 saveimage = global::LevelEditor.Properties.Resources.Sans_titre;
             }
             else if (selected == 13)
