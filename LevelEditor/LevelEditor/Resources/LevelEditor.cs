...
namespace LevelEditor
{
    public partial class LevelEditor : Form
    {
        ...
        System.Windows.Forms.PictureBox[] boxArray = new System.Windows.Forms.PictureBox[72];

        public LevelEditor()
        {
            InitializeComponent();
            #region list/arrays
            boxList.Add(pictureBox7); // 81
            ...
            for (int i = 0 + page*72; i < 72*page; i++) // C'est moche hein ?  C'est normal, c'est pour des tests.
            {
                boxArray[i] = boxList.First();
                boxList.RemoveAt(0);
            }
            selected = 0;
            page = 0;
        ...
        protected void pictureBox5_Click(object sender, EventArgs e)
        {
        ...
        {
            string position = "1";
            string time = Convert.ToString(2800 * page + 800);
        ...
        {
            string position = "1";
            string time = Convert.ToString(2800 * page + 1200);
        ...
        {
            string position = "1";
            string time = Convert.ToString(2800 * page + 1600);
        ...
        {
            string position = "1";
            string time = Convert.ToString(2800 * page + 2000);
        ...
        {
            string position = "1";
            string time = Convert.ToString(2800 * page + 2400);
        ...
        {
            string position = "1";
            string time = Convert.ToString(2800 * page + 2800);
